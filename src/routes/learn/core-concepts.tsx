  ...
  return (
    <main className="shell page">
      ...
      <div className="content-stack">
        ...
        <section className="content-card"><h2>Related verified concepts</h2><ul className="related-links"><li><Link to="/mechanics/$mechanicSlug" params={{ mechanicSlug: 'token' }}>Token</Link></li><li><Link to="/mechanics/$mechanicSlug" params={{ mechanicSlug: 'counter' }}>Counter</Link></li><li><Link to="/mechanics/$mechanicSlug" params={{ mechanicSlug: 'target' }}>Target</Link></li><li><Link to="/mechanics/$mechanicSlug" params={{ mechanicSlug: 'stack' }}>Stack</Link></li><li><Link to="/mechanics/$mechanicSlug" params={{ mechanicSlug: 'priority' }}>Priority and responding</Link></li><li><Link to="/mechanics/$mechanicSlug" params={{ mechanicSlug: 'resolution' }}>Resolution</Link></li></ul></section>
