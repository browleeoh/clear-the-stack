...
export const concepts: Concept[] = conceptSchema.array().parse([
  ...
  },
  {
    ...
    relatedConceptIds: ['stack', 'permanent', 'token', 'state-based-actions', 'this-way'],
    sourceIds: [
      'cr-rule-400-1',
      'cr-rule-400-7',
      'cr-rule-403-1',
  ...
  },
  {
    ...
    relatedConceptIds: ['zones', 'resolution'],
    sourceIds: ['cr-rule-400-7j', 'cr-rule-701-70a', 'hob-release-notes-recruit'],
    verificationStatus: 'verified',
    scenarios: [
      {
